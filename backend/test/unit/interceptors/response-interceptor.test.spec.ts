...
describe('Response Interceptor', () => {
  ...
  test.each([
    ...
    {
      actionResult: new InternalServerErrorObjectResult({ message: 'Internal Server Error' }),
    ...
    'intercept $actionResult should return status: $expectedStatusCode and body: $actionResult.body',
    async ({ actionResult, expectedStatusCode }) => {
      //Arrange
